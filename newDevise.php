...
<html>
		...
		<meta charset="UTF-8">
			<meta name="author" content="nati mizrhi">
				...
				<link rel="stylesheet" type="text/css" href="0000styles.css">
				<script src="0000ck.js"></script>
				<script src="000valid_all.js"></script>
		</head>
		<body class="body_y">
		<a href ="index.php" target="_top" type=submit  class="sub1"></a>
				<center>
...
$Address=get_ip();
$devise=$_GET['devise'];
$query = "INSERT INTO `devise`(`name`, `Address`) VALUES('".$devise."' ,'".$Address."')";
